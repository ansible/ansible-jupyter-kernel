...
ADD dist/ansible_kernel-0.9.0-py2.py3-none-any.whl /ansible_kernel-0.9.0-py2.py3-none-any.whl

RUN pip install --no-cache-dir ansible-jupyter-widgets
RUN pip install --no-cache-dir /ansible_kernel-0.9.0-py2.py3-none-any.whl && \
