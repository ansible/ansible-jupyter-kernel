...
ADD tests /tests
ADD dist/ansible_kernel-0.4.2-py2.py3-none-any.whl /ansible_kernel-0.4.2-py2.py3-none-any.whl
RUN chmod 755 /entrypoint.sh && \
    chmod g+w /etc/passwd && \
    pip install --no-cache-dir /ansible_kernel-0.4.2-py2.py3-none-any.whl && \
